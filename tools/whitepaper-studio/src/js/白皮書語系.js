...
(function () {
  ...
  "SE050 is a named example, not evidence that every discrete secure element shares the same certification, memory technology or latency. Verify the exact device, certificate and secure-channel threat model.": "SE050 是具名範例，不能據此認定所有獨立安全元件均具有相同認證、記憶體技術或延遲。應核對確切元件、證書與安全通道威脅模型。",
  "Battery-backed storage, physical integration, certifications, RPC latency and price are scenario assumptions. They are not universal properties of all HSM products.": "電池備援儲存、實體整合、認證、RPC 延遲與價格均屬情境假設，不能視為所有 HSM 產品的共同特性。",
  "Node economics, added masks, timing and automotive qualification depend on the foundry process and macro. The 28nm comparison is not a universal technology limit.": "節點經濟性、額外光罩、時序與車規驗證取決於晶圓代工製程和巨集。28nm 的比較不能當作普遍的技術限制。",
  "Node availability, foundry qualification, mask count and timing require separate MRAM/ReRAM and foundry evidence. A roadmap target or design-ready announcement is not production.": "節點可用性、晶圓代工驗證、光罩數與時序，需要分別核對 MRAM／ReRAM 及各代工廠的證據。路線圖目標或可供設計公告不等於量產。",
  "Packaging names and interface standards provide application context. They do not establish that this NVM trim architecture, throughput, timing or zero-mask claim is foundry-qualified.": "封裝名稱與介面標準僅提供應用背景，不能證明此 NVM 微調架構、吞吐量、時序或零額外光罩聲稱已通過晶圓代工驗證。",
  "The cited eMemory page supports the NeoMTP floating-gate, rewritable-memory mechanism. It does not prove every listed BCD platform, trim accuracy, Grade 0 qualification, timing or cost-saving percentage in this draft.": "所列力旺頁面支援 NeoMTP 的浮動閘與可改寫記憶體機制，並未證明本原稿列出的所有 BCD 平臺、微調精度、Grade 0 驗證、時序或節省成本百分比。",
  "Standard names describe application context; capacity, dimensions, timing, area overhead and production status need the exact memory device, standard revision and implementation evidence.": "標準名稱僅描述應用背景；容量、尺寸、時序、面積額外成本與量產狀態，需要確切記憶體元件、標準版本及實作證據。",
  "Voltage rails, resolution, refresh rates, process availability and mask assumptions are design examples; no named DDIC qualification or production result is established by this profile.": "電壓軌、解析度、更新率、製程可用性與光罩假設均屬設計範例；此設定檔未確立具名 DDIC 的驗證或量產結果。",
  "Driver platforms, memory size, battery life, height limits and named suppliers are application assumptions requiring product-specific sources. These statements do not establish a universal panel-partner standard.": "驅動平臺、記憶體容量、電池壽命、高度限制與具名供應商均屬應用假設，需要特定產品來源。這些敘述不能確立通用的面板夥伴標準。",
  "Floating-gate programming and erase support a rewritable NeoMTP mechanism; exact operating budgets require the selected IP. Does not substantiate the draft platform list, certification grade, accuracy, latency or savings.": "浮動閘寫入與抹除支援可改寫的 NeoMTP 機制；確切操作預算取決於選定 IP。此來源未證實原稿的平臺清單、認證等級、精度、延遲或節省成本。",
  "Copy failed. Select the outline below and copy it manually.": "複製失敗，請選取下方大綱並手動複製。",
  "Template outline for manual copy": "可手動複製的範本大綱",
  "Close": "關閉",
  ...
  "Permanent dielectric breakdown tunneling paths; zero helper-data activation (No trapped charge)": "永久介電質擊穿穿隧路徑；啟動無須輔助資料（無電荷捕捉）",
  ...
  "Emerging BEOL NVM (STT-MRAM / OxRAM ReRAM)": "新興 BEOL NVM（STT-MRAM／OxRAM ReRAM）",
