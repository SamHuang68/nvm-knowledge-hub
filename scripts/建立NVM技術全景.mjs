...
const chineseComparison = isEnglish ? JSON.parse(fs.readFileSync(path.join(root,'data/NVM比較與系統.json'),'utf8')) : comparison;
...
const searchEntries = [
 ...
 {title_zh:'歷史總表與有條件比較',title_en:'Historical and Current Comparisons',url:'NVM技術全景.html#comparison',tags:'2016 2021 2026 比較 能量 耐久 保持 延遲 endurance retention latency energy Actt TwinBit Floadia CFX Attopsemi SST I-fuse ZA ZT G1 G2 SuperFlash LogicFlash'},
 {title_zh:chineseComparison.logicIpMap.title,title_en:isEnglish?comparison.logicIpMap.title:chineseComparison.logicIpMap.title,url:'NVM技術全景.html#comparison-logic-ip',tags:'Actt TwinBit Floadia CFX Attopsemi SST I-fuse ZA ZT G1 G2 SuperFlash LogicFlash 選型矩陣 具名 IP'}
];
if (isEnglish) {
