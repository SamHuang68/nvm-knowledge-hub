...
${implementationTable(topic)}
  ...
  <section><h3>從專利讀回設計問題</h3><p>以下提供代表性研究入口。優先權日與受讓紀錄依文件書目；實施例與權利項的範圍分開閱讀。</p>${topic.patents.map(patent=>renderPatentTeaser(engineeringPatents.get(patent.id),language)).join('')}</section>
...
<footer class="nvm-footer"><p>NVM 知識中心 · 公開來源研究 · ${intro.revision}</p><a href="index.html">返回知識中心</a> · <a href="#sources">查看來源與共用資料</a></footer><script type="module" src="NVM技術全景.js?v=20260910-editorial4"></script><script type="module" src="NVM工程圖解.js?v=20260910"></script></body></html>\n`;
// 全頁標題使用標籤語法，不保留句尾標點。
