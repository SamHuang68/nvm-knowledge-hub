...
<main class="nvm-main" id="main-content"><noscript><p class="nvm-nojs">此頁已包含全部專題文字。啟用 JavaScript 可使用分頁閱讀、篩選與操作切換。</p></noscript>${panorama}${renderIPDirectory(ipCurriculum,language)}${renderIPLineage(ipCurriculum,language,cite)}${physicsPanel}${renderIPPanels(ipCurriculum,language,cite)}${comparisonPanel()}${foundryPanel()}${renderLandscape(research,language,cite)}${renderResearch(research,language,cite)}${topics.map(topicPanel).join('')}${comparison.systems.map(systemPanel).join('')}${patentPanel}${glossaryPanel}${sourcePanel}</main></div>
<footer class="nvm-footer"><p>NVM 知識中心 · 公開來源研究 · ${intro.revision}</p><a href="index.html">返回知識中心</a> · <a href="#sources">查看來源與共用資料</a></footer><script type="module" src="NVM技術全景.js?v=20260910-library"></script><script type="module" src="NVM工程圖解.js?v=20260910"></script></body></html>\n`;
// 全頁標題使用標籤語法，不保留句尾標點。
