...
<footer class="nvm-footer"><p>NVM 知識中心 · 公開來源研究 · ${intro.revision}</p><a href="index.html">返回知識中心</a> · <a href="#sources">查看來源與共用資料</a></footer><script type="module" src="NVM技術全景.js?v=20260911-editorial8"></script><script type="module" src="NVM工程圖解.js?v=20260910"></script></body></html>\n`;
// 全頁標題使用標籤語法，不保留句尾標點。
